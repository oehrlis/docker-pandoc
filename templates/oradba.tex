...
% noteblock, tipblock, warningblock, cautionblock, importantblock are provided
% natively by awesomebox - no redefinition needed
...
\ifnum 0\ifxetex 1\fi\ifluatex 1\fi=0 % if pdftex
  $if(fontfamily)$
  $else$
  \IfFileExists{sourcesanspro.sty}{\usepackage[default]{sourcesanspro}}{\usepackage{lmodern}}
