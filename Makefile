...
help: ## Show available targets and release workflow
	...
	@echo ""
	@echo "Release workflow (full sequence):"
	@echo "  1. make version-bump-patch    # bump 0.0.X → commit (or -minor / -major)"
	@echo "  2. make tag                   # create annotated git tag v<VERSION>"
	@echo "  3. git push origin master && git push origin v<VERSION>"
	@echo "  4. make build-release         # build all 4 variants locally with VERSION tags"
	@echo "  5. make build-multi           # build multi-platform and push to registry"
	@echo ""
	@echo "  Shortcut (patch only):  make release  # steps 1+2 combined, then do 3-5 manually"
	@echo ""
	@echo "Tag strategy:"
	...
	@echo "  make build-all                # build all dev-VARIANT images locally"
	@echo "  make test [VARIANT=x]         # test dev-VARIANT"
	@echo "  make test-all                 # test all dev-VARIANT images"
	@echo ""
	@echo "Targets:"
